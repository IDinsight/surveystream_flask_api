...
# This file contains data models for blueprints that are not yet migrated to Callisto
...
#     Description: This table contains the column configurations for the web app tables
#     """
