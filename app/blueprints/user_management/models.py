...
class UserLocation(db.Model):
    ...
    This table describes the location that a user is associated with
    """
    ...
    location_uid = db.Column(
        db.Integer(), db.ForeignKey(Location.location_uid), nullable=False
    )

    __table_args__ = (
        db.PrimaryKeyConstraint("survey_uid", "user_uid", "location_uid"),
        {"schema": "webapp"},
    )

    def __init__(self, survey_uid, user_uid, location_uid):
