...
def upgrade():
    ...
    with op.batch_alter_table("forms", schema="webapp") as batch_op:
        batch_op.rename_table("parent_forms", "forms", schema="webapp")
...
def downgrade():
    ...
    op.create_table(
        ...
        sa.Column("survey_uid", sa.INTEGER(), autoincrement=False, nullable=False),
        sa.Column("scto_form_id", sa.VARCHAR(), autoincrement=False, nullable=False),
        sa.Column("form_name", sa.VARCHAR(), autoincrement=False, nullable=False),
        sa.Column("tz_name", sa.VARCHAR(), autoincrement=False, nullable=True),
        sa.Column("scto_server_name", sa.VARCHAR(), autoincrement=False, nullable=True),
        sa.Column(
            "encryption_key_shared", sa.BOOLEAN(), autoincrement=False, nullable=True
        ),
        sa.Column(
        ...
        sa.Column(
            "server_access_allowed", sa.BOOLEAN(), autoincrement=False, nullable=True
        ),
        sa.Column(
            "last_ingested_at",
        ...
        sa.ForeignKeyConstraint(
            ...
            name="fk_parent_forms_survey_uid_surveys",
            ondelete="CASCADE",
        ),
        sa.PrimaryKeyConstraint("form_uid", name="pk_parent_forms"),
        sa.UniqueConstraint(
    ...
    op.drop_table("forms", schema="webapp")

    op.rename_table("parent_forms", "forms", schema="webapp")

    with op.batch_alter_table("forms", schema="webapp") as batch_op:
        batch_op.rename_table("forms", "parent_forms", schema="webapp")
