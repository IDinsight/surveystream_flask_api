...
Revision ID: 8f4470b28bbf
Revises: 48b3877a09e6
Create Date: 2024-10-23 12:51:51.354877
...
def upgrade():
    ...
    op.create_table(
        ...
        sa.Column("form_uid", sa.Integer(), nullable=False),
        sa.Column(
            "target_source", sa.String(length=8), server_default="csv", nullable=False
        ),
        sa.Column(
            "target_source",
            sa.String(length=8),
...
def downgrade():
    ...
    op.drop_table("target_scto_question")
    # ### end Alembic commands ###
