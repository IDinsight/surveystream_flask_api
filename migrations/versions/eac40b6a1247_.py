"""
Add Email Template Tables and Email Table Filters
Revision ID: eac40b6a1247
Revises: 1d1aed6b6f50
Create Date: 2024-08-30 10:12:02.744948
...
revision = "eac40b6a1247"
down_revision = "1d1aed6b6f50"
branch_labels = None
depends_on = None
...
def upgrade():
    ...
    op.create_table(
        ...
        sa.Column(
            "email_template_table_uid", sa.Integer(), autoincrement=True, nullable=False
        ),
        ...
        sa.ForeignKeyConstraint(
            ...
            name=op.f("fk_email_template_tables_email_template_uid_email_templates"),
        ),
        sa.PrimaryKeyConstraint(
            "email_template_table_uid", name=op.f("pk_email_template_tables")
        ),
        sa.UniqueConstraint(
            "email_template_uid",
            "table_name",
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(
            ...
            ["webapp.email_template_tables.email_template_table_uid"],
            name=op.f(
        ...
        sa.PrimaryKeyConstraint(
            ...
            "filter_operator",
            "filter_value",
            name=op.f("pk_email_table_filters"),
        ),
        schema="webapp",
    )
    with op.batch_alter_table("email_schedule_filters", schema="webapp") as batch_op:
        ...
        batch_op.drop_constraint("ck_email_schedule_filters_operator", type_="check")
