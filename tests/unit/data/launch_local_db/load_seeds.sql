...
COPY webapp.notification_actions (module_id,name,message,notification_template_list) FROM '/docker-entrypoint-initdb.d/data/notification_actions.csv' DELIMITER ',' CSV HEADER;