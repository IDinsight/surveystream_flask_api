COPY webapp.users (user_uid,email,password_secure,first_name,middle_name,last_name,home_state,home_district,phone_primary,phone_secondary,avatar_s3_filekey,active) FROM '/docker-entrypoint-initdb.d/data/webapp.users.csv' DELIMITER ',' CSV HEADER;
