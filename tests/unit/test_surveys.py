...
@pytest.fixture()
def create_survey(client, login_test_user, csrf_token, test_user_credentials):
    """
...
def test_create_survey(client, login_test_user, create_survey, test_user_credentials):
    """
...
def test_update_survey(client, login_test_user, create_survey, csrf_token):
    """
...
def test_delete_survey(
    client, login_test_user, create_survey, csrf_token, test_user_credentials
):
    """
