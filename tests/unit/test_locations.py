...
class TestLocations:
    ...
    def test_get_locations_with_uid(
        self,
        client,
        login_test_user,
        upload_locations_csv,
        ...
        """
        Test that the locations can be fetched with a location uid
        """
        ...
        # Check the response
        response = client.get("/api/locations/uid", query_string={"survey_uid": 1})
